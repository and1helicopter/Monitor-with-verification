...
namespace GUIElements
{
    public partial class InputValueForm : Form
    {
        ...
        private void CreateBody(InputValueFormModes Mode, InputValueFormSettings ShowSettings)
        {
            ...
            if (Mode == InputValueFormModes.SecretMode)
            {
                SecretMode = true;
            }
        }

        public InputValueForm(InputValueFormModes Mode, InputValueFormSettings ShowSettings, string Titl = "")
        {
            CreateBody(Mode, ShowSettings);
            TitlString = Titl;
        }

        public InputValueForm(InputValueFormModes Mode)
        {
            InputValueFormSettings sets = new InputValueFormSettings(0, 9999, 0);
            CreateBody(Mode, sets);
        }
